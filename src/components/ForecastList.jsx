        ...
        <div className="w-full flex overflow-x-auto pb-6 gap-4 hide-scrollbar snap-x">
            {dailyForecast.map((item, index) => (
                <motion.div
                    ...
                    className="glass-card flex-shrink-0 w-36 md:w-44 p-6 flex flex-col items-center justify-between gap-4 snap-center group transition-colors"
                >
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-[10px] font-bold uppercase opacity-40 mt-1 truncate w-24">
                            {item.weather[0].main}
                        </p>
                    </div>
                </motion.div>
